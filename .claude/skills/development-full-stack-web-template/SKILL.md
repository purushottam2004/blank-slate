---
name: development-full-stack-web-template
description: >-
  Development workflow for this full-stack web template monorepo
---
...
**Strict:** do **not** tell the user a task is done, complete, finished, or ready until you have **actually run** the relevant tests / quality checks for the packages you changed (root [CONTRIBUTING.md](../../../CONTRIBUTING.md) quality bar).
...
Embedded IDE browsers often cannot reach local apps (`localhost` / `127.0.0.1`). Verify local UIs with Playwright (`e2e/`) or `curl` against `127.0.0.1`.

## After you finish

If the work reveals missing or wrong docs, update the relevant README / SETUP_GUIDE / CONTRIBUTING (or note it for the human), per [CONTRIBUTING.md](../../../CONTRIBUTING.md).
